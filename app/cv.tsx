...
const CV: React.FC<CVProps> = ({ imageSrc, personalInfo, educationInfo, skillsInfo, workInfo, certificationInfo }) => {
    return(
        ...
        {/* A4 Container */}
        <div id="cv-container" className="flex bg-white w-full max-w-[210mm] min-h-[297mm] md:border rounded-lg shadow-lg overflow-hidden md:flex">
          
          {/* Left Side Section */}
          <div className="bg-[#411d1d] text-white text-sm p-6 md:p-20 w-[45%] md:w-[40%] text-center border-r-4 md:border-b-0 md:border-r-4 border-cyan-500">
            <div className="flex justify-center items-center w-[80px] h-[100px] md:w-[150px] md:h-[150px] mt-4 md:mt-[10%] mb-6 md:mb-[20%] border rounded-lg border-cyan-500 shadow-lg shadow-cyan-500">
              {/* Image Placeholder */}
              {imageSrc ? (
            ...
            <section id="certification_section" className="space-y-2 md:space-y-4 text-sm md:text-xl ">
            ...
            <div>
              <div>
                <CvRightSectionHeading>Personal Information</CvRightSectionHeading>
                       ...
                       <section id="personal_info" className="space-y-2 md:space-y-4 text-sm md:text-xl">
              ...
              <section id="education_section" className="space-y-2 md:space-y-4 text-sm md:text-xl ">
              ...
              <section id="skill_section"  className="space-y-2 md:space-y-4 text-sm md:text-xl ">
              ...
              <section id="Work_exper"  className="space-y-2 md:space-y-4 text-sm md:text-xl">
                {workInfo.map((input) => (
                <p key={input.id}>
                {input.label} <span>{input.value}</span>
                </p>
