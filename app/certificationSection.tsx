...
interface CertificationProps {
  setCertificationInfo: (skills: InputField[]) => void; // Function to send data back to the parent component (CV)
}

  const CertificationSection: React.FC<CertificationProps> = ({ setCertificationInfo }) => {
    const [inputs, setInputs] = useState<InputField[]>([{ id: 1, label: "Certification:",value: "" }, { id: 2, label: "Institute:",value: "" }]);
  ...
  const handleChange = (id: number, value: string) => {
    ...
    setCertificationInfo(updatedInputs); // Send updated data to the parent component (CV)
  };
  ...
  const addInputs = () => {
    ...
    const newInputs = [
      ...inputs,
      { id: newId1, label: "Certification:", value: "" },
      { id: newId2, label: "Institute:", value: "" },
    ];
    setInputs(newInputs);
    setCertificationInfo(newInputs); // Send updated data to the parent component (CV)
  };
    ...
    return(
        <div className=" pt-16 pb-16 bg-cover bg-no-repeat" style={{backgroundImage: "url('/images/bgnew.png')"}}>
            <section><Sectionheading>Certification Section</Sectionheading></section>
            <br />
            <br />
